...
return [
    ...
    'expected_values' => [
        ...
        ['value' => 48, 'property_path' => 'disadvantages[2].advantage.id'],
        ...
        ['value' => 0, 'property_path' => 'domains.scienceBonus'],
        ['value' => 0, 'property_path' => 'domains.shootingAndThrowing'],
        ['value' => 0, 'property_path' => 'domains.shootingAndThrowingBonus'],
        ['value' => 0, 'property_path' => 'domains.travel'],
        ['value' => 0, 'property_path' => 'domains.travelBonus'],
