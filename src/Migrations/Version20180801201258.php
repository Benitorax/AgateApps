...
final class Version20180801201258 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('
            ...
            ADD indication_type VARCHAR(20) NOT NULL DEFAULT "'.CharacterAlteration::INDICATION_TYPE_SINGLE_VALUE.'",
        ...
        $this->addSql('
            ...
            [
                ...
                ':indication_type' => CharacterAlteration::INDICATION_TYPE_SINGLE_CHOICE,
